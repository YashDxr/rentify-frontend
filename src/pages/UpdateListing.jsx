...
//   console.log(formData);
  ...
  //We cannot create async on useEffect as it already has that behaviour,
  // instead we create an async function inside useEffect and call it inside it
  useEffect(()=>{
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://rentify-backend-7zr8kctt9-yashs-projects-0cbfb7bb.vercel.app/api/listing/update/${params.listingId}`, {
        method: "POST",
        headers: {
